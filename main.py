...
# This function contains the code for log in functionality
...
# This function contains the code for creating the query
    def Creat_query(self):

            # Clicking query section
